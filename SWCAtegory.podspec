#
#  Be sure to run `pod spec lint SWCAtegory.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/Heshuwang/SWCategory.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "SWCategory/**/*.{h,m}"
